...
import { clearFlightDetail, getFlights, getOnlyIda } from "../../Redux/Actions";
...
export default function CardDetail(){
    ...
    if(flightDetail.length){
        localStorage.setItem('cardDetail', JSON.stringify(flightDetail))
    }
    let flightDetailRespaldo = JSON.parse(localStorage.getItem('cardDetail'))
    console.log(flightDetailRespaldo)
    ...
    return(
        <div className="container mt-5 mb-5">
...

            {
                ...
                flightDetailRespaldo[0].segments.map( (el, i) => {
