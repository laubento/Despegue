...
export default function Admin() {
  ...
  const columnsOffers = [
    ...
    },
    {
      ...
      validate: (rowData) => {
        if (rowData.nameAirportFrom === "" || !rowData.nameAirportFrom)
          return "Required";
        else if (rowData.nameAirportFrom.length !== 3)
          return "Tiene que contener 3 letras";
        return true;
      },
      // type: 'time',
      // editable: false,
    },
    {
      ...
      field: "nameAirportTo",
      validate: (rowData) => {
        if (rowData.nameAirportTo === "" || !rowData.nameAirportTo)
          return "Required";
        else if (rowData.nameAirportTo.length !== 3)
          return "Tiene que contener 3 letras";
        return true;
      },
      // type: 'time',
