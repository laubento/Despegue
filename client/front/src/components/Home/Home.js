...
function Home(props) {
  ...
  let vuelo =
    undefined || null ? "" : JSON.parse(localStorage.getItem("detail"));
  console.log(vuelo);
  // useEffect(e => {
  //   dispatch(listUsers())
  // }, [dispatch])
  ...
  return (
    <div>
      <div className="p-4">
        ...
        {vuelo === null || vuelo === undefined ? (
          <div className="d-flex justify-content-center">
            <span className="text-center FlightSearch-errorsText font-weight-bold mt-2">
              {cancel}
            </span>{" "}
          </div>
        ) : (
                      ...
                      <div className="d-flex justify-content-center">
                        <div className="card-div row ">
                          ...
                          <div className="col-2 container card-border-left card-price-box">
                            ...
                            <div className="card-div-price-btn"></div>
                          </div>
                        </div>
                      </div>
                    );
            ...
            <div className="col-9 p-2">
              ...
              <div className="Promociones-containerPortada shadow">
                ...
                <div className="p-2 Promociones-a">
                  <h4>
                    Descubrí nuestras ofertas en los mejores destinos pagando en
                    cuotas.
                  </h4>
                  <Link to={"/ofertas"} className="Promociones-Link">
                    Ofertas
                  </Link>
                </div>
              </div>
